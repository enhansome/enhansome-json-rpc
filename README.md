...
* .NET
  * [Microsoft/vs-streamjsonrpc](https://github.com/Microsoft/vs-streamjsonrpc) ⭐ 936 | 🐛 30 | 🌐 C# | 📅 2026-09-16 - The StreamJsonRpc library offers JSON-RPC 2.0 over any .NET Stream, WebSocket, or Pipe. With bonus support for request cancellation, client proxy generation, and more.
...
* [Dogecoin](https://github.com/dogecoin/dogecoin) ⭐ 15,233 | 🐛 316 | 🌐 C++ | 📅 2026-09-10 - Dogecoin is a cryptocurrency featuring a likeness of the Shiba Inu dog from the "Doge" Internet meme as its logo.
* [Monero](https://github.com/monero-project/monero) ⭐ 10,854 | 🐛 645 | 🌐 C++ | 📅 2026-09-10 - the secure, private, untraceable cryptocurrency.
...
* [Litecoin](https://github.com/litecoin-project/litecoin) ⭐ 4,604 | 🐛 106 | 🌐 C++ | 📅 2026-09-16 - Litecoin is a cryptocurrency that enables instant payments to anyone in the world and that can be efficiently mined with consumer-grade hardware.
* [Dash](https://github.com/dashpay/dash) ⭐ 1,538 | 🐛 226 | 🌐 C++ | 📅 2026-09-15 - Dash is Digital Cash You Can Spend Anywhere.
* [Microsoft SQL Tools Service](https://github.com/Microsoft/sqltoolsservice/) ⭐ 508 | 🐛 70 | 🌐 C# | 📅 2026-09-16 - SQL Query and Management over JSON-RPC.
