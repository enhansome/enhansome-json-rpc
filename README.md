...
* .NET
  * [Microsoft/vs-streamjsonrpc](https://github.com/Microsoft/vs-streamjsonrpc) ⭐ 934 | 🐛 62 | 🌐 C# | 📅 2026-08-17 - The StreamJsonRpc library offers JSON-RPC 2.0 over any .NET Stream, WebSocket, or Pipe. With bonus support for request cancellation, client proxy generation, and more.
...
* Nim
  * [nim-json-rpc](https://github.com/status-im/nim-json-rpc) ⭐ 101 | 🐛 9 | 🌐 Nim | 📅 2026-08-17 - Nim library for implementing JSON-RPC clients and servers
...
* [Monero](https://github.com/monero-project/monero) ⭐ 10,781 | 🐛 686 | 🌐 C++ | 📅 2026-08-17 - the secure, private, untraceable cryptocurrency.
...
* [Litecoin](https://github.com/litecoin-project/litecoin) ⭐ 4,598 | 🐛 104 | 🌐 C++ | 📅 2026-08-14 - Litecoin is a cryptocurrency that enables instant payments to anyone in the world and that can be efficiently mined with consumer-grade hardware.
* [Dash](https://github.com/dashpay/dash) ⭐ 1,540 | 🐛 243 | 🌐 C++ | 📅 2026-08-17 - Dash is Digital Cash You Can Spend Anywhere.
* [Microsoft SQL Tools Service](https://github.com/Microsoft/sqltoolsservice/) ⭐ 506 | 🐛 77 | 🌐 C# | 📅 2026-08-17 - SQL Query and Management over JSON-RPC.
