...
* Javascript
  * [Jayson](https://github.com/tedeh/jayson) ⭐ 727 | 🐛 1 | 🌐 JavaScript | 📅 2025-12-22 - Jayson is a simple but featureful JSON-RPC 2.0/1.0 client and server for node.js
...
* .NET
  * [Microsoft/vs-streamjsonrpc](https://github.com/Microsoft/vs-streamjsonrpc) ⭐ 934 | 🐛 64 | 🌐 C# | 📅 2026-08-12 - The StreamJsonRpc library offers JSON-RPC 2.0 over any .NET Stream, WebSocket, or Pipe. With bonus support for request cancellation, client proxy generation, and more.
...
* Nim
  * [nim-json-rpc](https://github.com/status-im/nim-json-rpc) ⭐ 101 | 🐛 10 | 🌐 Nim | 📅 2026-08-08 - Nim library for implementing JSON-RPC clients and servers
...
* [open-rpc/generator-client](https://github.com/open-rpc/generator-client) ⭐ 97 | 🐛 23 | 🌐 TypeScript | 📅 2025-10-22 - Mono repo for the client generators for each target language
...
* [Dogecoin](https://github.com/dogecoin/dogecoin) ⭐ 15,257 | 🐛 305 | 🌐 C++ | 📅 2026-07-23 - Dogecoin is a cryptocurrency featuring a likeness of the Shiba Inu dog from the "Doge" Internet meme as its logo.
* [Monero](https://github.com/monero-project/monero) ⭐ 10,770 | 🐛 688 | 🌐 C++ | 📅 2026-08-12 - the secure, private, untraceable cryptocurrency.
...
* [Litecoin](https://github.com/litecoin-project/litecoin) ⭐ 4,597 | 🐛 103 | 🌐 C++ | 📅 2026-07-31 - Litecoin is a cryptocurrency that enables instant payments to anyone in the world and that can be efficiently mined with consumer-grade hardware.
* [Dash](https://github.com/dashpay/dash) ⭐ 1,540 | 🐛 242 | 🌐 C++ | 📅 2026-08-13 - Dash is Digital Cash You Can Spend Anywhere.
* [Microsoft SQL Tools Service](https://github.com/Microsoft/sqltoolsservice/) ⭐ 505 | 🐛 75 | 🌐 C# | 📅 2026-08-13 - SQL Query and Management over JSON-RPC.
