...
* .NET
  * [Microsoft/vs-streamjsonrpc](https://github.com/Microsoft/vs-streamjsonrpc) ⭐ 935 | 🐛 61 | 🌐 C# | 📅 2026-08-23 - The StreamJsonRpc library offers JSON-RPC 2.0 over any .NET Stream, WebSocket, or Pipe. With bonus support for request cancellation, client proxy generation, and more.
...
* Nim
  * [nim-json-rpc](https://github.com/status-im/nim-json-rpc) ⭐ 101 | 🐛 11 | 🌐 Nim | 📅 2026-08-24 - Nim library for implementing JSON-RPC clients and servers
...
* [Monero](https://github.com/monero-project/monero) ⭐ 10,791 | 🐛 700 | 🌐 C++ | 📅 2026-08-23 - the secure, private, untraceable cryptocurrency.
...
* [Dash](https://github.com/dashpay/dash) ⭐ 1,542 | 🐛 238 | 🌐 C++ | 📅 2026-08-23 - Dash is Digital Cash You Can Spend Anywhere.
