...
* .NET
  ...
  * [JSON-RPC.NET](https://github.com/Astn/JSON-RPC.NET) ⭐ 328 | 🐛 7 | 🌐 C# | 📅 2026-09-24 - JSON-RPC.Net is a high performance Json-Rpc 2.0 server, leveraging the popular JSON.NET library. Host in ASP.NET, also supports sockets and pipes, oh my!
...
* [Monero](https://github.com/monero-project/monero) ⭐ 10,871 | 🐛 610 | 🌐 C++ | 📅 2026-09-24 - the secure, private, untraceable cryptocurrency.
...
* [Dash](https://github.com/dashpay/dash) ⭐ 1,538 | 🐛 222 | 🌐 C++ | 📅 2026-09-24 - Dash is Digital Cash You Can Spend Anywhere.
