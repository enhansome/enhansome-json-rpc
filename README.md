...
* .NET
  * [Microsoft/vs-streamjsonrpc](https://github.com/Microsoft/vs-streamjsonrpc) ⭐ 936 | 🐛 32 | 🌐 C# | 📅 2026-09-10 - The StreamJsonRpc library offers JSON-RPC 2.0 over any .NET Stream, WebSocket, or Pipe. With bonus support for request cancellation, client proxy generation, and more.
...
* Nim
  * [nim-json-rpc](https://github.com/status-im/nim-json-rpc) ⭐ 102 | 🐛 11 | 🌐 Nim | 📅 2026-09-07 - Nim library for implementing JSON-RPC clients and servers
...
* C
  * [cesanta/mjson](https://github.com/cesanta/mjson) ⭐ 468 | 🐛 26 | 🌐 C | 📅 2025-03-05 - C/C++ JSON parser, emitter, JSON-RPC engine for embedded systems
...
* [Dogecoin](https://github.com/dogecoin/dogecoin) ⭐ 15,232 | 🐛 306 | 🌐 C++ | 📅 2026-09-10 - Dogecoin is a cryptocurrency featuring a likeness of the Shiba Inu dog from the "Doge" Internet meme as its logo.
* [Monero](https://github.com/monero-project/monero) ⭐ 10,843 | 🐛 610 | 🌐 C++ | 📅 2026-09-10 - the secure, private, untraceable cryptocurrency.
...
* [Litecoin](https://github.com/litecoin-project/litecoin) ⭐ 4,603 | 🐛 107 | 🌐 C++ | 📅 2026-09-05 - Litecoin is a cryptocurrency that enables instant payments to anyone in the world and that can be efficiently mined with consumer-grade hardware.
* [Dash](https://github.com/dashpay/dash) ⭐ 1,540 | 🐛 240 | 🌐 C++ | 📅 2026-09-10 - Dash is Digital Cash You Can Spend Anywhere.
* [Microsoft SQL Tools Service](https://github.com/Microsoft/sqltoolsservice/) ⭐ 508 | 🐛 71 | 🌐 C# | 📅 2026-09-10 - SQL Query and Management over JSON-RPC.
