...
* .NET
  * [Microsoft/vs-streamjsonrpc](https://github.com/Microsoft/vs-streamjsonrpc) ⭐ 936 | 🐛 59 | 🌐 C# | 📅 2026-08-24 - The StreamJsonRpc library offers JSON-RPC 2.0 over any .NET Stream, WebSocket, or Pipe. With bonus support for request cancellation, client proxy generation, and more.
...
* [Monero](https://github.com/monero-project/monero) ⭐ 10,798 | 🐛 693 | 🌐 C++ | 📅 2026-08-25 - the secure, private, untraceable cryptocurrency.
...
* [Microsoft SQL Tools Service](https://github.com/Microsoft/sqltoolsservice/) ⭐ 507 | 🐛 68 | 🌐 C# | 📅 2026-08-25 - SQL Query and Management over JSON-RPC.
