...
* [Monero](https://github.com/monero-project/monero) ⭐ 10,857 | 🐛 647 | 🌐 C++ | 📅 2026-09-10 - the secure, private, untraceable cryptocurrency.
...
* [Litecoin](https://github.com/litecoin-project/litecoin) ⭐ 4,604 | 🐛 108 | 🌐 C++ | 📅 2026-09-18 - Litecoin is a cryptocurrency that enables instant payments to anyone in the world and that can be efficiently mined with consumer-grade hardware.
* [Dash](https://github.com/dashpay/dash) ⭐ 1,538 | 🐛 230 | 🌐 C++ | 📅 2026-09-18 - Dash is Digital Cash You Can Spend Anywhere.
* [Microsoft SQL Tools Service](https://github.com/Microsoft/sqltoolsservice/) ⭐ 508 | 🐛 71 | 🌐 C# | 📅 2026-09-18 - SQL Query and Management over JSON-RPC.
