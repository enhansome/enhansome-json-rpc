...
* .NET
  * [Microsoft/vs-streamjsonrpc](https://github.com/Microsoft/vs-streamjsonrpc) ⭐ 934 | 🐛 35 | 🌐 C# | 📅 2026-09-07 - The StreamJsonRpc library offers JSON-RPC 2.0 over any .NET Stream, WebSocket, or Pipe. With bonus support for request cancellation, client proxy generation, and more.
...
* Nim
  * [nim-json-rpc](https://github.com/status-im/nim-json-rpc) ⭐ 101 | 🐛 10 | 🌐 Nim | 📅 2026-09-07 - Nim library for implementing JSON-RPC clients and servers
...
* [open-rpc/spec](https://github.com/open-rpc/spec) ⭐ 216 | 🐛 30 | 🌐 TypeScript | 📅 2026-09-05 - Specification for OpenRPC
...
* [Dogecoin](https://github.com/dogecoin/dogecoin) ⭐ 15,235 | 🐛 305 | 🌐 C++ | 📅 2026-08-15 - Dogecoin is a cryptocurrency featuring a likeness of the Shiba Inu dog from the "Doge" Internet meme as its logo.
* [Monero](https://github.com/monero-project/monero) ⭐ 10,841 | 🐛 647 | 🌐 C++ | 📅 2026-09-03 - the secure, private, untraceable cryptocurrency.
...
* [Litecoin](https://github.com/litecoin-project/litecoin) ⭐ 4,602 | 🐛 105 | 🌐 C++ | 📅 2026-09-05 - Litecoin is a cryptocurrency that enables instant payments to anyone in the world and that can be efficiently mined with consumer-grade hardware.
* [Dash](https://github.com/dashpay/dash) ⭐ 1,541 | 🐛 244 | 🌐 C++ | 📅 2026-09-08 - Dash is Digital Cash You Can Spend Anywhere.
* [Microsoft SQL Tools Service](https://github.com/Microsoft/sqltoolsservice/) ⭐ 508 | 🐛 71 | 🌐 C# | 📅 2026-09-08 - SQL Query and Management over JSON-RPC.
