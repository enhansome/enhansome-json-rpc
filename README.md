...
* .NET
  * [Microsoft/vs-streamjsonrpc](https://github.com/Microsoft/vs-streamjsonrpc) ⭐ 937 | 🐛 28 | 🌐 C# | 📅 2026-09-22 - The StreamJsonRpc library offers JSON-RPC 2.0 over any .NET Stream, WebSocket, or Pipe. With bonus support for request cancellation, client proxy generation, and more.
  * [JSON-RPC.NET](https://github.com/Astn/JSON-RPC.NET) ⭐ 328 | 🐛 21 | 🌐 C# | 📅 2026-09-23 - JSON-RPC.Net is a high performance Json-Rpc 2.0 server, leveraging the popular JSON.NET library. Host in ASP.NET, also supports sockets and pipes, oh my!
...
* [Dogecoin](https://github.com/dogecoin/dogecoin) ⭐ 15,232 | 🐛 318 | 🌐 C++ | 📅 2026-09-10 - Dogecoin is a cryptocurrency featuring a likeness of the Shiba Inu dog from the "Doge" Internet meme as its logo.
* [Monero](https://github.com/monero-project/monero) ⭐ 10,869 | 🐛 627 | 🌐 C++ | 📅 2026-09-23 - the secure, private, untraceable cryptocurrency.
...
* [Dash](https://github.com/dashpay/dash) ⭐ 1,538 | 🐛 223 | 🌐 C++ | 📅 2026-09-23 - Dash is Digital Cash You Can Spend Anywhere.
