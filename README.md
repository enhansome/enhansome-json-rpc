...
* .NET
  * [Microsoft/vs-streamjsonrpc](https://github.com/Microsoft/vs-streamjsonrpc) ⭐ 938 | 🐛 29 | 🌐 C# | 📅 2026-09-25 - The StreamJsonRpc library offers JSON-RPC 2.0 over any .NET Stream, WebSocket, or Pipe. With bonus support for request cancellation, client proxy generation, and more.
  * [JSON-RPC.NET](https://github.com/Astn/JSON-RPC.NET) ⭐ 328 | 🐛 0 | 🌐 C# | 📅 2026-09-25 - JSON-RPC.Net is a high performance Json-Rpc 2.0 server, leveraging the popular JSON.NET library. Host in ASP.NET, also supports sockets and pipes, oh my!
...
* Nim
  * [nim-json-rpc](https://github.com/status-im/nim-json-rpc) ⭐ 104 | 🐛 11 | 🌐 Nim | 📅 2026-09-11 - Nim library for implementing JSON-RPC clients and servers
...
* [open-rpc/spec](https://github.com/open-rpc/spec) ⭐ 217 | 🐛 32 | 🌐 TypeScript | 📅 2026-09-05 - Specification for OpenRPC
...
* [open-rpc/meta-schema](https://github.com/open-rpc/meta-schema) ⭐ 34 | 🐛 15 | 🌐 Go | 📅 2026-09-21 - JSON Schema file representing the open-rpc specification.
...
* [Dogecoin](https://github.com/dogecoin/dogecoin) ⭐ 15,233 | 🐛 320 | 🌐 C++ | 📅 2026-09-10 - Dogecoin is a cryptocurrency featuring a likeness of the Shiba Inu dog from the "Doge" Internet meme as its logo.
* [Monero](https://github.com/monero-project/monero) ⭐ 10,876 | 🐛 616 | 🌐 C++ | 📅 2026-09-25 - the secure, private, untraceable cryptocurrency.
...
* [Litecoin](https://github.com/litecoin-project/litecoin) ⭐ 4,604 | 🐛 111 | 🌐 C++ | 📅 2026-09-18 - Litecoin is a cryptocurrency that enables instant payments to anyone in the world and that can be efficiently mined with consumer-grade hardware.
* [Dash](https://github.com/dashpay/dash) ⭐ 1,540 | 🐛 214 | 🌐 C++ | 📅 2026-09-25 - Dash is Digital Cash You Can Spend Anywhere.
