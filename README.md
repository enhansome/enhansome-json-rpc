...
* .NET
  * [Microsoft/vs-streamjsonrpc](https://github.com/Microsoft/vs-streamjsonrpc) ⭐ 933 | 🐛 34 | 🌐 C# | 📅 2026-09-02 - The StreamJsonRpc library offers JSON-RPC 2.0 over any .NET Stream, WebSocket, or Pipe. With bonus support for request cancellation, client proxy generation, and more.
...
* Nim
  * [nim-json-rpc](https://github.com/status-im/nim-json-rpc) ⭐ 101 | 🐛 11 | 🌐 Nim | 📅 2026-08-29 - Nim library for implementing JSON-RPC clients and servers
...
* C
  * [cesanta/mjson](https://github.com/cesanta/mjson) ⭐ 467 | 🐛 26 | 🌐 C | 📅 2025-03-05 - C/C++ JSON parser, emitter, JSON-RPC engine for embedded systems
...
* [open-rpc/spec](https://github.com/open-rpc/spec) ⭐ 216 | 🐛 30 | 🌐 TypeScript | 📅 2026-02-25 - Specification for OpenRPC
...
* [Dogecoin](https://github.com/dogecoin/dogecoin) ⭐ 15,258 | 🐛 309 | 🌐 C++ | 📅 2026-08-15 - Dogecoin is a cryptocurrency featuring a likeness of the Shiba Inu dog from the "Doge" Internet meme as its logo.
* [Monero](https://github.com/monero-project/monero) ⭐ 10,817 | 🐛 690 | 🌐 C++ | 📅 2026-09-02 - the secure, private, untraceable cryptocurrency.
...
* [Litecoin](https://github.com/litecoin-project/litecoin) ⭐ 4,603 | 🐛 104 | 🌐 C++ | 📅 2026-09-01 - Litecoin is a cryptocurrency that enables instant payments to anyone in the world and that can be efficiently mined with consumer-grade hardware.
* [Dash](https://github.com/dashpay/dash) ⭐ 1,541 | 🐛 239 | 🌐 C++ | 📅 2026-08-31 - Dash is Digital Cash You Can Spend Anywhere.
* [Microsoft SQL Tools Service](https://github.com/Microsoft/sqltoolsservice/) ⭐ 508 | 🐛 69 | 🌐 C# | 📅 2026-09-02 - SQL Query and Management over JSON-RPC.
